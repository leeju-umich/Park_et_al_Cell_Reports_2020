...
obj <- readRDS("../../rds/sw.mt_04142020.rds")

gene.names <- rownames(obj@assays$RNA@data)
meta <- obj@meta.data[,c('nCount_RNA','nFeature_RNA','percent.mt','dose','dose_batch')]
